...
//Starts a session like in other controllers
session_start();
//Bring in the other controllers and functions into scope
require_once '../library/connections.php';
require_once '../model/main-model.php';
require_once '../model/vehicles-model.php';
require_once '../model/uploads-model.php';
require_once '../library/functions.php';
//Build a nav-list for the view
$classifications = getClassifications();
//call the function to create the main navigation bar
$navList = createNavlist($classifications);

//Capture data coming from links or forms: INPUT_POST for forms INPUT_POST for links
...
//Switch block for the upload and delete functions that allow the images to be uploaded and deleted
switch ($action) {
    case 'upload':
